...
HD_PWD='C:/CR/Projeto/Task_53/Task_53.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log task_design_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source task_design_1_wrapper.tcl -notrace
