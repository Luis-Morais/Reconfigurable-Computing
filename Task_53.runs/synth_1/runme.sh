...
HD_PWD='C:/CR/Projeto/Task_53/Task_53.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log task_design_1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source task_design_1_wrapper.tcl
