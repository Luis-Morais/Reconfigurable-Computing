...
HD_PWD='C:/CR/Projeto/Task_53/UserDefinedRepository/compVGA/compVGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_for_block.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_for_block.tcl
