...
HD_PWD='C:/CR/Projeto/Task_53/UserDefinedRepository/FSM_Common_Divisor/FSM_Common_Divisor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FSM_max_common_divisor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FSM_max_common_divisor.tcl
