...
HD_PWD='C:/CR/Projeto/Task_53/UserDefinedRepository/Unroll/Unroll.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Unroll_ROM_last.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Unroll_ROM_last.tcl
