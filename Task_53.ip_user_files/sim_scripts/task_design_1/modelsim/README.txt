...
#
# Generated by export_simulation on Wed Jun 07 06:25:12 +0100 2017
#
################################################################################
...
switch to the './task_design_1.sh' script.

./task_design_1.sh -reset_run
...
./task_design_1.sh -noclean_files

For more information on the script, please type './task_design_1.sh -help'.
